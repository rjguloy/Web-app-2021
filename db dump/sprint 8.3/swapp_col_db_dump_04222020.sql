...
-- Dumping data for table swapp_col.checklistactivitydate: ~6 rows (approximately)
...
-- Dumping data for table swapp_col.hazard: ~45 rows (approximately)
DELETE FROM `hazard`;
...
-- Dumping data for table swapp_col.location: ~12 rows (approximately)
...
-- Dumping data for table swapp_col.record: ~30 rows (approximately)
DELETE FROM `record`;
...
-- Dumping data for table swapp_col.recordaction: ~30 rows (approximately)
...
-- Dumping data for table swapp_col.recordphoto: ~74 rows (approximately)
...
-- Dumping data for table swapp_col.school: ~36 rows (approximately)
DELETE FROM `school`;
...
-- Dumping data for table swapp_col.sublocation: ~65 rows (approximately)
...
-- Dumping data for table swapp_col.summary: ~34 rows (approximately)
DELETE FROM `summary`;
