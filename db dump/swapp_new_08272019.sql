...
-- Dumping data for table swapp2.account: ~0 rows (approximately)
...
-- Dumping structure for table swapp2.checklistactivitydate
...
-- Dumping data for table swapp2.checklistactivitydate: ~0 rows (approximately)
/*!40000 ALTER TABLE `checklistactivitydate` DISABLE KEYS */;
/*!40000 ALTER TABLE `checklistactivitydate` ENABLE KEYS */;


-- Dumping structure for table swapp2.hazard
...
-- Dumping data for table swapp2.hazard: ~42 rows (approximately)
...
-- Dumping structure for table swapp2.hazardcategory
...
-- Dumping data for table swapp2.hazardcategory: ~5 rows (approximately)
...
-- Dumping structure for table swapp2.hazarditem
...
-- Dumping data for table swapp2.hazarditem: ~49 rows (approximately)
...
-- Dumping structure for table swapp2.hazardstatus
...
-- Dumping data for table swapp2.hazardstatus: ~8 rows (approximately)
...
-- Dumping structure for table swapp2.hazardtype
...
-- Dumping data for table swapp2.hazardtype: ~5 rows (approximately)
...
-- Dumping structure for table swapp2.location
...
-- Dumping data for table swapp2.location: ~0 rows (approximately)
/*!40000 ALTER TABLE `location` DISABLE KEYS */;
/*!40000 ALTER TABLE `location` ENABLE KEYS */;


-- Dumping structure for table swapp2.loginaccess
...
-- Dumping data for table swapp2.loginaccess: ~0 rows (approximately)
/*!40000 ALTER TABLE `loginaccess` DISABLE KEYS */;
/*!40000 ALTER TABLE `loginaccess` ENABLE KEYS */;


-- Dumping structure for table swapp2.narrative
...
-- Dumping data for table swapp2.narrative: ~0 rows (approximately)
/*!40000 ALTER TABLE `narrative` DISABLE KEYS */;
/*!40000 ALTER TABLE `narrative` ENABLE KEYS */;


-- Dumping structure for table swapp2.record
...
-- Dumping data for table swapp2.record: ~0 rows (approximately)
/*!40000 ALTER TABLE `record` DISABLE KEYS */;
/*!40000 ALTER TABLE `record` ENABLE KEYS */;


-- Dumping structure for table swapp2.recordaction
...
-- Dumping data for table swapp2.recordaction: ~0 rows (approximately)
/*!40000 ALTER TABLE `recordaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `recordaction` ENABLE KEYS */;


-- Dumping structure for table swapp2.recordphoto
...
-- Dumping data for table swapp2.recordphoto: ~0 rows (approximately)
/*!40000 ALTER TABLE `recordphoto` DISABLE KEYS */;
/*!40000 ALTER TABLE `recordphoto` ENABLE KEYS */;


-- Dumping structure for table swapp2.school
...
-- Dumping data for table swapp2.school: ~0 rows (approximately)
/*!40000 ALTER TABLE `school` DISABLE KEYS */;
INSERT INTO `school` (`seqid`, `id`, `depedserver`, `name`, `address`, `approver`, `reviewer`, `createdby`, `createstatus`, `createdate`) VALUES
	(1, 1, '0.0.0.0', 'Default High School', 'Muntinlupa City', 'Mr. Approver', 'Mr. Reviewer', 'SYSTEM', 'ACTIVE', '2019-08-27 17:51:48');
/*!40000 ALTER TABLE `school` ENABLE KEYS */;


-- Dumping structure for table swapp2.securityquestion
...
-- Dumping data for table swapp2.securityquestion: ~10 rows (approximately)
...
-- Dumping structure for procedure swapp2.sp_account_add
...
-- Dumping structure for procedure swapp2.sp_account_update
...
-- Dumping structure for procedure swapp2.sp_checklistactivitydate_add
...
-- Dumping structure for procedure swapp2.sp_checklistactivitydate_delete
...
-- Dumping structure for procedure swapp2.sp_checklistactivitydate_getByDate
...
-- Dumping structure for procedure swapp2.sp_checklistactivitydate_getByID
...
-- Dumping structure for procedure swapp2.sp_checklistactivitydate_getList
...
-- Dumping structure for procedure swapp2.sp_checklist_ByType
...
-- Dumping structure for procedure swapp2.sp_hazardcat_get
...
-- Dumping structure for procedure swapp2.sp_locations_add
...
-- Dumping structure for procedure swapp2.sp_locations_delete
...
-- Dumping structure for procedure swapp2.sp_locations_get
...
-- Dumping structure for procedure swapp2.sp_locations_get_beta
DROP PROCEDURE IF EXISTS `sp_locations_get_beta`;
DELIMITER //
CREATE DEFINER=`root`@`%` PROCEDURE `sp_locations_get_beta`()
BEGIN
	SELECT 
		a.seqid 					AS bldg_seqid,
		a.id 						AS bldg_id,
...
-- Dumping structure for procedure swapp2.sp_locations_update
...
-- Dumping structure for procedure swapp2.sp_location_check
...
-- Dumping structure for procedure swapp2.sp_loginaccess_add
...
-- Dumping structure for procedure swapp2.sp_loginaccess_delete
...
-- Dumping structure for procedure swapp2.sp_schoolinfo_get
...
-- Dumping structure for procedure swapp2.sp_schoolinfo_save
...
-- Dumping structure for procedure swapp2.sp_securityquestion_getlistrandom
...
-- Dumping structure for procedure swapp2.sp_sublocation_add
...
-- Dumping structure for procedure swapp2.sp_sublocation_check
...
-- Dumping structure for procedure swapp2.sp_sublocation_delete
...
-- Dumping structure for procedure swapp2.sp_sublocation_update
...
-- Dumping structure for procedure swapp2.sp_swt_members_get
...
-- Dumping structure for procedure swapp2.sp_swt_permissions_get
...
-- Dumping structure for procedure swapp2.sp_user_add
...
-- Dumping structure for procedure swapp2.sp_user_approve
...
-- Dumping structure for procedure swapp2.sp_user_delete
...
-- Dumping structure for procedure swapp2.sp_user_getbyusername
...
BEGIN
	...
	SELECT `user`.username AS username, name, validationdate, `password`, account.createdate AS passworddate, 
...
-- Dumping structure for procedure swapp2.sp_user_getbywildcard
...
-- Dumping structure for procedure swapp2.sp_user_getlist
...
-- Dumping structure for table swapp2.sublocation
...
-- Dumping data for table swapp2.sublocation: ~0 rows (approximately)
/*!40000 ALTER TABLE `sublocation` DISABLE KEYS */;
/*!40000 ALTER TABLE `sublocation` ENABLE KEYS */;


-- Dumping structure for table swapp2.summary
...
-- Dumping data for table swapp2.summary: ~0 rows (approximately)
/*!40000 ALTER TABLE `summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `summary` ENABLE KEYS */;


-- Dumping structure for table swapp2.swt
...
-- Dumping data for table swapp2.swt: ~15 rows (approximately)
/*!40000 ALTER TABLE `swt` DISABLE KEYS */;
INSERT INTO `swt` (`seqid`, `id`, `name`, `gender`, `team`, `createdby`, `createstatus`, `createdate`) VALUES
	(1, 'A1', 'Studetn A1', 'M', 'A', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(2, 'A2', 'Studetn A2', 'F', 'A', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(3, 'A3', 'Studetn A3', 'M', 'A', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(4, 'A4', 'Studetn A4', 'M', 'A', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(5, 'A5', 'Studetn A5', 'F', 'A', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(6, 'B1', 'Studetn B1', 'M', 'B', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(7, 'B2', 'Studetn B2', 'M', 'B', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(8, 'B3', 'Studetn B3', 'F', 'B', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(9, 'B4', 'Studetn B4', 'F', 'B', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(10, 'B5', 'Studetn B5', 'M', 'B', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(11, 'C1', 'Studetn C1', 'M', 'C', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(12, 'C2', 'Studetn C2', 'F', 'C', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(13, 'C3', 'Studetn C3', 'F', 'C', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(14, 'C4', 'Studetn C4', 'M', 'C', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10'),
	(15, 'C5', 'Studetn C5', 'F', 'C', 'SYSTEM', 'ACTIVE', '2019-08-27 09:59:10');
/*!40000 ALTER TABLE `swt` ENABLE KEYS */;


-- Dumping structure for table swapp2.swtpermission
...
-- Dumping data for table swapp2.swtpermission: ~0 rows (approximately)
/*!40000 ALTER TABLE `swtpermission` DISABLE KEYS */;
/*!40000 ALTER TABLE `swtpermission` ENABLE KEYS */;


-- Dumping structure for table swapp2.user
...
-- Dumping data for table swapp2.user: ~0 rows (approximately)
...
-- Dumping structure for table swapp2.user_securityquestion
...
-- Dumping data for table swapp2.user_securityquestion: ~3 rows (approximately)
