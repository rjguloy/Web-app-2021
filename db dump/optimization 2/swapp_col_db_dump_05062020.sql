...
-- Dumping data for table swapp_col.checklistactivitydate: ~7 rows (approximately)
...
-- Dumping data for table swapp_col.hazard: ~44 rows (approximately)
DELETE FROM `hazard`;
...
-- Dumping data for table swapp_col.location: ~16 rows (approximately)
...
-- Dumping data for table swapp_col.record: ~36 rows (approximately)
DELETE FROM `record`;
...
-- Dumping data for table swapp_col.recordaction: ~36 rows (approximately)
...
-- Dumping data for table swapp_col.recordphoto: ~91 rows (approximately)
...
-- Dumping data for table swapp_col.sublocation: ~78 rows (approximately)
...
-- Dumping data for table swapp_col.summary: ~38 rows (approximately)
DELETE FROM `summary`;
