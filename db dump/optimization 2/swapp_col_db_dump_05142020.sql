...
-- Dumping data for table swapp_col.checklistactivitydate: ~0 rows (approximately)
...
-- Dumping data for table swapp_col.location: ~0 rows (approximately)
...
-- Dumping data for table swapp_col.record: ~0 rows (approximately)
DELETE FROM `record`;
...
-- Dumping data for table swapp_col.recordaction: ~0 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Dumping data for table swapp_col.recordphoto: ~0 rows (approximately)
...
-- Dumping data for table swapp_col.sublocation: ~0 rows (approximately)
...
-- Dumping data for table swapp_col.summary: ~0 rows (approximately)
DELETE FROM `summary`;
