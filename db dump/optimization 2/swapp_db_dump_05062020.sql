...
-- Dumping data for table swapp.account: ~133 rows (approximately)
DELETE FROM `account`;
...
-- Dumping data for table swapp.checklistactivitydate: ~47 rows (approximately)
...
-- Dumping data for table swapp.hazard: ~43 rows (approximately)
DELETE FROM `hazard`;
...
INSERT INTO `hazard` (`seqid`, `id`, `school_id`, `name`, `description`, `type`, `createdby`, `createstatus`, `createdate`) VALUES
	...
	(13, 13, 0, 'Exposed chemicals and liquids', NULL, 'CAPACITY', 'SYSTEM', 'ACTIVE', '2019-08-06 16:08:59'),
	...
	(31, 31, 0, 'Swinging doors', NULL, 'HAZARD', 'SYSTEM', 'ACTIVE', '2019-08-06 16:08:59'),
...
-- Dumping data for table swapp.location: ~43 rows (approximately)
...
-- Dumping data for table swapp.loginaccess: ~0 rows (approximately)
DELETE FROM `loginaccess`;
...
-- Dumping data for table swapp.narrative: ~6 rows (approximately)
...
-- Dumping data for table swapp.record: ~6 rows (approximately)
DELETE FROM `record`;
...
-- Dumping data for table swapp.recordaction: ~20 rows (approximately)
...
-- Dumping data for table swapp.recordphoto: ~30 rows (approximately)
...
-- Dumping data for table swapp.school: ~88 rows (approximately)
DELETE FROM `school`;
/*!40000 ALTER TABLE `school` DISABLE KEYS */;
INSERT INTO `school` (`seqid`, `id`, `depedserver`, `name`, `address`, `approver`, `reviewer`, `createdby`, `createstatus`, `createdate`) VALUES
	(1, 100002, '1001', 'Default School', NULL, 'Mr. Approver', 'Mr. Reviewer', 'SYSTEM', 'ACTIVE', '2020-04-18 04:24:10');
...
DROP PROCEDURE IF EXISTS `sp_checklistactivitydate_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_data_delete_aftersendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_get_checklistactivitydate_getlast3`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_hazard_getsendtoserver`;
DELIMITER //
...
BEGIN
	...
	CALL sp_locations_add(i_id, i_school, i_name, i_user, 'UPDATE');
END//
DELIMITER ;
...
DROP PROCEDURE IF EXISTS `sp_location_getlist`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_location_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_narrative_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_pdf_gethazardstatus_count`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_pdf_gethazardtype_count`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_pdf_hazardtype_count_get`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_recordaction_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_recordphoto_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_record_getchecklistactivity`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_record_getcomparativedata`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_record_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_record_getsendtoserver_hazard`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_record_getsendtoserver_photo`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_record_validate`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_reportphoto_action_add`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_reportphoto_action_check`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_reportphoto_action_update`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_reportphoto_bydate`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_reportphoto_byrecord`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_reportphoto_images_delete`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_sublocation_getlistbylocation`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_sublocation_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_summary_add`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_summary_forpdf`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_summary_getsendtoserver`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_summary_hazardstatus_get`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_summary_hazardtype_get`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_summary_records_bydate_get`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_swt_permissions_id_check`;
DELIMITER //
...
DROP PROCEDURE IF EXISTS `sp_swt_permissions_update`;
DELIMITER //
...
CREATE TABLE IF NOT EXISTS `sublocation` (
  ...
  `hazardcategory_id` int(11) NOT NULL DEFAULT 1,
  `name` varchar(100) NOT NULL,
  `createdby` varchar(50) NOT NULL,
  `createstatus` enum('ACTIVE','UPDATED','DELETED') NOT NULL DEFAULT 'ACTIVE',
  `createdate` timestamp NOT NULL DEFAULT current_timestamp(),
  ...
  KEY `FK_sublocation_hazardcategory` (`hazardcategory_id`),
  CONSTRAINT `FK_sublocation_hazardcategory` FOREIGN KEY (`hazardcategory_id`) REFERENCES `hazardcategory` (`id`),
...
-- Dumping data for table swapp.sublocation: ~83 rows (approximately)
...
-- Dumping data for table swapp.summary: ~15 rows (approximately)
DELETE FROM `summary`;
...
-- Dumping data for table swapp.swt: ~92 rows (approximately)
DELETE FROM `swt`;
...
-- Dumping data for table swapp.swtpermission: ~23 rows (approximately)
DELETE FROM `swtpermission`;
...
-- Dumping data for table swapp.user: ~71 rows (approximately)
DELETE FROM `user`;
...
-- Dumping data for table swapp.user_securityquestion: ~111 rows (approximately)
DELETE FROM `user_securityquestion`;
...
INSERT INTO `user_securityquestion` (`seqid`, `username`, `securityquestion_id`, `answer`, `createdate`) VALUES
	(1, 'superadmin', 10, 'admin', '2019-08-22 07:52:50'),
	(2, 'superadmin', 7, 'admin', '2019-08-22 07:52:50'),
	(3, 'superadmin', 6, 'admin', '2019-08-22 07:52:50');
