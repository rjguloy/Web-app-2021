...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_dashboard_school_submission_get`(IN `i_year` INT, IN `i_school` INT, IN `i_cad` INT
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_dashboard_submission_get`(IN `i_year` INT, IN `i_item` INT, IN `i_school` INT, IN `i_cad` INT
...
DROP PROCEDURE IF EXISTS `sp_reports_get`;
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_reports_get`(IN `i_year` INT, IN `i_item` INT, IN `i_school` INT, IN `i_cad` INT
