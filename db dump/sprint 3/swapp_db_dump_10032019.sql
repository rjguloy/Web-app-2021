...
-- Dumping data for table swapp.checklistactivitydate: ~8 rows (approximately)
...
-- Dumping data for table swapp.location: ~19 rows (approximately)
...
-- Dumping data for table swapp.recordaction: ~17 rows (approximately)
...
-- Dumping data for table swapp.recordphoto: ~36 rows (approximately)
...
-- Dumping data for table swapp.sublocation: ~18 rows (approximately)
...
-- Dumping data for table swapp.summary: ~7 rows (approximately)
